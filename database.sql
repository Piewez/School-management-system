...
INSERT INTO `auth_permission` VALUES (1,'Can add log entry',1,'add_logentry'),(2,'Can change log entry',1,'change_logentry'),(3,'Can delete log entry',1,'delete_logentry'),(4,'Can view log entry',1,'view_logentry'),(5,'Can add permission',2,'add_permission'),(6,'Can change permission',2,'change_permission'),(7,'Can delete permission',2,'delete_permission'),(8,'Can view permission',2,'view_permission'),(9,'Can add group',3,'add_group'),(10,'Can change group',3,'change_group'),(11,'Can delete group',3,'delete_group'),(12,'Can view group',3,'view_group'),(13,'Can add content type',4,'add_contenttype'),(14,'Can change content type',4,'change_contenttype'),(15,'Can delete content type',4,'delete_contenttype'),(16,'Can view content type',4,'view_contenttype'),(17,'Can add session',5,'add_session'),(18,'Can change session',5,'change_session'),(19,'Can delete session',5,'delete_session'),(20,'Can view session',5,'view_session'),(21,'Can add user',6,'add_customuser'),(22,'Can change user',6,'change_customuser'),(23,'Can delete user',6,'delete_customuser'),(24,'Can view user',6,'view_customuser'),(25,'Can add attendance',7,'add_attendance'),(26,'Can change attendance',7,'change_attendance'),(27,'Can delete attendance',7,'delete_attendance'),(28,'Can view attendance',7,'view_attendance'),(29,'Can add classes',8,'add_classes'),(30,'Can change classes',8,'change_classes'),(31,'Can delete classes',8,'delete_classes'),(32,'Can view classes',8,'view_classes'),(33,'Can add session year model',9,'add_sessionyearmodel'),(34,'Can change session year model',9,'change_sessionyearmodel'),(35,'Can delete session year model',9,'delete_sessionyearmodel'),(36,'Can view session year model',9,'view_sessionyearmodel'),(37,'Can add matieres',10,'add_matieres'),(38,'Can change matieres',10,'change_matieres'),(39,'Can delete matieres',10,'delete_matieres'),(40,'Can view matieres',10,'view_matieres'),(41,'Can add students',11,'add_students'),(42,'Can change students',11,'change_students'),(43,'Can delete students',11,'delete_students'),(44,'Can view students',11,'view_students'),(45,'Can add professeurs',12,'add_professeurs'),(46,'Can change professeurs',12,'change_professeurs'),(47,'Can delete professeurs',12,'delete_professeurs'),(48,'Can view professeurs',12,'view_professeurs'),(49,'Can add notification student',13,'add_notificationstudent'),(50,'Can change notification student',13,'change_notificationstudent'),(51,'Can delete notification student',13,'delete_notificationstudent'),(52,'Can view notification student',13,'view_notificationstudent'),(53,'Can add notification professeurs',14,'add_notificationprofesseurs'),(54,'Can change notification professeurs',14,'change_notificationprofesseurs'),(55,'Can delete notification professeurs',14,'delete_notificationprofesseurs'),(56,'Can view notification professeurs',14,'view_notificationprofesseurs'),(57,'Can add leave report student',15,'add_leavereportstudent'),(58,'Can change leave report student',15,'change_leavereportstudent'),(59,'Can delete leave report student',15,'delete_leavereportstudent'),(60,'Can view leave report student',15,'view_leavereportstudent'),(61,'Can add leave report professeur',16,'add_leavereportprofesseur'),(62,'Can change leave report professeur',16,'change_leavereportprofesseur'),(63,'Can delete leave report professeur',16,'delete_leavereportprofesseur'),(64,'Can view leave report professeur',16,'view_leavereportprofesseur'),(65,'Can add feed back student',17,'add_feedbackstudent'),(66,'Can change feed back student',17,'change_feedbackstudent'),(67,'Can delete feed back student',17,'delete_feedbackstudent'),(68,'Can view feed back student',17,'view_feedbackstudent'),(69,'Can add feed back professeurs',18,'add_feedbackprofesseurs'),(70,'Can change feed back professeurs',18,'change_feedbackprofesseurs'),(71,'Can delete feed back professeurs',18,'delete_feedbackprofesseurs'),(72,'Can view feed back professeurs',18,'view_feedbackprofesseurs'),(73,'Can add attendance report',19,'add_attendancereport'),(74,'Can change attendance report',19,'change_attendancereport'),(75,'Can delete attendance report',19,'delete_attendancereport'),(76,'Can view attendance report',19,'view_attendancereport'),(77,'Can add admin hod',20,'add_adminhod'),(78,'Can change admin hod',20,'change_adminhod'),(79,'Can delete admin hod',20,'delete_adminhod'),(80,'Can view admin hod',20,'view_adminhod');
...
INSERT INTO `django_content_type` VALUES (1,'admin','logentry'),(3,'auth','group'),(2,'auth','permission'),(4,'contenttypes','contenttype'),(5,'sessions','session'),(20,'student_management_app','adminhod'),(7,'student_management_app','attendance'),(19,'student_management_app','attendancereport'),(8,'student_management_app','classes'),(6,'student_management_app','customuser'),(18,'student_management_app','feedbackprofesseurs'),(17,'student_management_app','feedbackstudent'),(16,'student_management_app','leavereportprofesseur'),(15,'student_management_app','leavereportstudent'),(14,'student_management_app','notificationprofesseurs'),(13,'student_management_app','notificationstudent'),(9,'student_management_app','sessionyearmodel'),(12,'student_management_app','professeurs'),(11,'student_management_app','students'),(10,'student_management_app','matieres');
...
CREATE TABLE `student_management_app_attendance` (
  ...
  KEY `student_management_a_matiere_id_id_9ae82fd0_fk_student_m` (`matiere_id_id`),
  ...
  CONSTRAINT `student_management_a_matiere_id_id_9ae82fd0_fk_student_m` FOREIGN KEY (`matiere_id_id`) REFERENCES `student_management_app_matieres` (`id`)
...
--
-- Table structure for table `student_management_app_classes`
--

DROP TABLE IF EXISTS `student_management_app_classes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `student_management_app_classes` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `student_management_app_classes`
--

LOCK TABLES `student_management_app_classes` WRITE;
/*!40000 ALTER TABLE `student_management_app_classes` DISABLE KEYS */;
INSERT INTO `student_management_app_classes` VALUES (1,'BCA','2020-04-12 08:37:10.306437','2020-04-12 08:37:10.306437'),(2,'BBA','2020-04-12 08:37:14.880271','2020-04-12 08:37:14.880271'),(3,'MBA','2020-04-12 08:37:18.160619','2020-04-12 08:37:18.160619'),(4,'MCA','2020-04-12 08:37:21.825105','2020-04-12 08:37:21.825105');
/*!40000 ALTER TABLE `student_management_app_classes` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `student_management_app_feedbackprofesseurs`
--

DROP TABLE IF EXISTS `student_management_app_feedbackprofesseurs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `student_management_app_feedbackprofesseurs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `feedback` longtext NOT NULL,
  `feedback_reply` longtext NOT NULL,
  `created_at` datetime(6) NOT NULL,
  `updated_at` datetime(6) NOT NULL,
  `professeur_id_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `student_management_a_professeur_id_id_6f22a616_fk_student_m` (`professeur_id_id`),
  CONSTRAINT `student_management_a_professeur_id_id_6f22a616_fk_student_m` FOREIGN KEY (`professeur_id_id`) REFERENCES `student_management_app_professeurs` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `student_management_app_feedbackprofesseurs`
--

LOCK TABLES `student_management_app_feedbackprofesseurs` WRITE;
/*!40000 ALTER TABLE `student_management_app_feedbackprofesseurs` DISABLE KEYS */;
INSERT INTO `student_management_app_feedbackprofesseurs` VALUES (1,'Testing Feedback Message','I will Contact You','2020-05-02 13:39:42.882248','2020-05-02 13:39:42.882248',1),(2,'New Testing','Thanks','2020-05-02 13:40:58.015222','2020-05-02 13:40:58.015222',1);
/*!40000 ALTER TABLE `student_management_app_feedbackprofesseurs` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `student_management_app_leavereportprofesseur`
--

DROP TABLE IF EXISTS `student_management_app_leavereportprofesseur`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `student_management_app_leavereportprofesseur` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `professeur_id_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `student_management_a_professeur_id_id_c7710cd5_fk_student_m` (`professeur_id_id`),
  CONSTRAINT `student_management_a_professeur_id_id_c7710cd5_fk_student_m` FOREIGN KEY (`professeur_id_id`) REFERENCES `student_management_app_professeurs` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `student_management_app_leavereportprofesseur`
--

LOCK TABLES `student_management_app_leavereportprofesseur` WRITE;
/*!40000 ALTER TABLE `student_management_app_leavereportprofesseur` DISABLE KEYS */;
INSERT INTO `student_management_app_leavereportprofesseur` VALUES (1,'2020-05-17','Borther Marriage',1,'2020-05-02 13:20:13.981434','2020-05-02 13:20:13.981434',1),(2,'2020-05-24','Sister Marriage',2,'2020-05-02 13:21:20.513330','2020-05-02 13:21:20.513330',1),(3,'2020-05-31','Just Leave',0,'2020-05-02 13:31:45.231819','2020-05-02 13:31:45.231819',1);
/*!40000 ALTER TABLE `student_management_app_leavereportprofesseur` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `student_management_app_notificationprofesseurs`
--

DROP TABLE IF EXISTS `student_management_app_notificationprofesseurs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `student_management_app_notificationprofesseurs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `professeur_id_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `student_management_a_professeur_id_id_2d336ab5_fk_student_m` (`professeur_id_id`),
  CONSTRAINT `student_management_a_professeur_id_id_2d336ab5_fk_student_m` FOREIGN KEY (`professeur_id_id`) REFERENCES `student_management_app_professeurs` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `student_management_app_notificationprofesseurs`
--

LOCK TABLES `student_management_app_notificationprofesseurs` WRITE;
/*!40000 ALTER TABLE `student_management_app_notificationprofesseurs` DISABLE KEYS */;
/*!40000 ALTER TABLE `student_management_app_notificationprofesseurs` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `student_management_app_professeurs`
--

DROP TABLE IF EXISTS `student_management_app_professeurs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `student_management_app_professeurs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `student_management_app_professeurs`
--

LOCK TABLES `student_management_app_professeurs` WRITE;
/*!40000 ALTER TABLE `student_management_app_professeurs` DISABLE KEYS */;
INSERT INTO `student_management_app_professeurs` VALUES (1,'Professeur One Address 1','2020-04-12 08:38:05.762808','2020-04-12 08:38:05.762808',2),(2,'Professeur Two Address','2020-04-12 08:38:30.048488','2020-04-12 08:38:30.049488',3),(3,'Professeur Three Address','2020-04-12 08:38:51.316112','2020-04-12 08:38:51.316112',4),(4,'Professeur Four Address','2020-04-12 08:39:17.451888','2020-04-12 08:39:17.451888',5);
/*!40000 ALTER TABLE `student_management_app_professeurs` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `student_management_app_students` (
  ...
  `updated_at` datetime(6) NOT NULL,
  `admin_id` int(11) NOT NULL,
  `classe_id_id` int(11) NOT NULL,
  `session_year_id_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `admin_id` (`admin_id`),
  KEY `student_management_a_classe_id_id_fcd09bed_fk_student_m` (`classe_id_id`),
  ...
  CONSTRAINT `student_management_a_classe_id_id_fcd09bed_fk_student_m` FOREIGN KEY (`classe_id_id`) REFERENCES `student_management_app_classes` (`id`),
...
INSERT INTO `student_management_app_students` VALUES (2,'Male','/media/python-student-10_Sa6Q7zb.png','Student One Address','2020-04-12 08:59:08.573132','2020-04-12 08:59:08.573132',13,1,1),(3,'Male','/media/python-student-10_cv5uwSU.png','Professeur Two Address Addd','2020-04-12 09:00:14.779121','2020-04-12 09:00:14.779121',14,1,1);
/*!40000 ALTER TABLE `student_management_app_students` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `student_management_app_matieres`
--

DROP TABLE IF EXISTS `student_management_app_matieres`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `student_management_app_matieres` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `professeur_id_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `student_management_a_classe_id_id_342668dd_fk_student_m` (`classe_id_id`),
  KEY `student_management_a_professeur_id_id_5f47119a_fk_student_m` (`professeur_id_id`),
  CONSTRAINT `student_management_a_classe_id_id_342668dd_fk_student_m` FOREIGN KEY (`classe_id_id`) REFERENCES `student_management_app_classes` (`id`),
  CONSTRAINT `student_management_a_professeur_id_id_5f47119a_fk_student_m` FOREIGN KEY (`professeur_id_id`) REFERENCES `student_management_app_customuser` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `student_management_app_matieres`
--

LOCK TABLES `student_management_app_matieres` WRITE;
/*!40000 ALTER TABLE `student_management_app_matieres` DISABLE KEYS */;
INSERT INTO `student_management_app_matieres` VALUES (1,'Java','2020-04-12 08:39:32.320256','2020-04-12 08:39:32.320256',1,2),(2,'PHP','2020-04-12 08:39:36.671226','2020-04-12 08:39:36.671226',1,2),(3,'MySql','2020-04-12 08:39:45.961429','2020-04-12 08:39:45.961429',1,2),(4,'HTML','2020-04-12 08:39:51.772865','2020-04-12 08:39:51.772865',1,2),(5,'Accounts','2020-04-12 08:40:01.554850','2020-04-12 08:40:01.554850',2,3),(6,'Marketing','2020-04-12 08:40:16.095706','2020-04-12 08:40:16.095706',2,3),(7,'ETP','2020-04-12 08:40:27.113388','2020-04-12 08:40:27.113388',2,3),(8,'Math','2020-04-12 08:40:39.975428','2020-04-12 08:40:39.975428',4,4),(9,'Python','2020-04-12 08:40:48.928138','2020-04-12 08:40:48.928138',4,4),(10,'Machine Learning','2020-04-12 08:40:57.217406','2020-04-12 08:40:57.217406',4,4),(11,'Artifical Intelligence','2020-04-12 08:41:11.197563','2020-04-12 08:41:11.197563',4,4),(12,'Cost Accounting','2020-04-12 08:41:20.505769','2020-04-12 08:41:20.505769',3,5),(13,'Financial Accounting','2020-04-12 08:41:29.711299','2020-04-12 08:41:29.711299',3,5),(14,'Statistics','2020-04-12 08:41:49.726616','2020-04-12 08:41:49.726616',3,5);
/*!40000 ALTER TABLE `student_management_app_matieres` ENABLE KEYS */;
UNLOCK TABLES;
