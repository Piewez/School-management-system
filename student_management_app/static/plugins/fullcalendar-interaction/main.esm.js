...
var HitDragging = /** @class */ (function () {
    ...
    HitDragging.prototype.processFirstCoord = function (ev) {
        ...
        if (matiereEl !== document) {
            matiereRect = computeRect(matiereEl);
            adjustedPoint = constrainPoint(adjustedPoint, matiereRect);
        }
        var initialHit = this.initialHit = this.queryHitForOffset(adjustedPoint.left, adjustedPoint.top);
        if (initialHit) {
            if (this.useMatiereCenter && matiereRect) {
                var slicedMatiereRect = intersectRects(matiereRect, initialHit.rect);
                if (slicedMatiereRect) {
                    adjustedPoint = getRectCenter(slicedMatiereRect);
                }
            }
...
var EventDragging = /** @class */ (function (_super) {
    ...
    function EventDragging(settings) {
        ...
        _this.handlePointerDown = function (ev) {
            ...
            var matiereSeg = _this.matiereSeg = getElSeg(ev.matiereEl);
            ...
            if (_this.isDragging) {
                ...
                if (validMutation) {
                    ...
                    if (receivingCalendar === initialCalendar_1) {
                        ...
                        var eventDropArg = __assign({}, transformed, { el: ev.matiereEl, delta: validMutation.datesDelta, oldEvent: eventApi, event: new EventApi(// the data AFTER the mutation
...
var EventDragging$1 = /** @class */ (function (_super) {
    ...
    EventDragging.prototype.querySeg = function (ev) {
        return getElSeg(elementClosest(ev.matiereEl, this.component.fgSegSelector));
    };
    return EventDragging;
}(Interaction));
...
var ExternalElementDragging = /** @class */ (function () {
    ...
    ExternalElementDragging.prototype.buildDragMeta = function (matiereEl) {
        if (typeof this.suppliedDragMeta === 'object') {
            ...
            return parseDragMeta(this.suppliedDragMeta(matiereEl));
        }
        else {
