    ...
    */
    var PointerDragging = /** @class */ (function () {
        function PointerDragging(containerEl) {
            ...
            this.selector = ''; // will cause matiereEl in all emitted events to be this element
            this.handleSelector = '';
        ...
        PointerDragging.prototype.queryMatiereEl = function (ev) {
            if (this.selector) {
            ...
            _this.onPointerDown = function (ev) {
                if (!_this.isDragging) { // so new drag doesn't happen while revert animation is going
                    ...
                    if (!_this.pointer.shouldIgnoreMove) {
                        ...
                        _this.mirror.start(ev.matiereEl, ev.pageX, ev.pageY); // must happen on first pointer down
                        _this.startDelay(ev);
    ...
    */
    var HitDragging = /** @class */ (function () {
        ...
        HitDragging.prototype.processFirstCoord = function (ev) {
            ...
            var matiereEl = ev.matiereEl;
            var matiereRect;
            if (matiereEl !== document) {
                matiereRect = core.computeRect(matiereEl);
                adjustedPoint = core.constrainPoint(adjustedPoint, matiereRect);
            }
            var initialHit = this.initialHit = this.queryHitForOffset(adjustedPoint.left, adjustedPoint.top);
            if (initialHit) {
                if (this.useMatiereCenter && matiereRect) {
                    var slicedMatiereRect = core.intersectRects(matiereRect, initialHit.rect);
                    if (slicedMatiereRect) {
                        adjustedPoint = core.getRectCenter(slicedMatiereRect);
                    }
                }
    ...
    */
    ...
    var EventDragging = /** @class */ (function (_super) {
        ...
        function EventDragging(settings) {
            var _this = _super.call(this, settings) || this;
            // internal state
            _this.matiereSeg = null; // the seg being selected/dragged
            ...
            _this.handlePointerDown = function (ev) {
                ...
                var matiereSeg = _this.matiereSeg = core.getElSeg(ev.matiereEl);
                var eventRange = _this.eventRange = matiereSeg.eventRange;
                ...
                _this.isDragging = isValid &&
                    ev.matiereEl.classList.contains('fc-draggable');
            };
            _this.handleDragStart = function (ev) {
                ...
                if (_this.isDragging) {
                    ...
                    if (validMutation) {
                        ...
                        if (receivingCalendar === initialCalendar_1) {
                            ...
                            var eventDropArg = __assign({}, transformed, { el: ev.matiereEl, delta: validMutation.datesDelta, oldEvent: eventApi, event: new core.EventApi(// the data AFTER the mutation
                            ...
                            var dropArg = __assign({}, receivingCalendar.buildDatePointApi(finalHit.dateSpan), { draggedEl: ev.matiereEl, jsEvent: ev.origEvent, view: finalHit.component // should this be finalHit.component.view? See #4644
                             });
            ...
            hitDragging.useMatiereCenter = settings.useEventCenter;
            hitDragging.emitter.on('pointerdown', _this.handlePointerDown);
            hitDragging.emitter.on('dragstart', _this.handleDragStart);
            hitDragging.emitter.on('hitupdate', _this.handleHitUpdate);
            hitDragging.emitter.on('pointerup', _this.handlePointerUp);
    ...
    var EventDragging$1 = /** @class */ (function (_super) {
        ...
        function EventDragging(settings) {
            var _this = _super.call(this, settings) || this;
            // internal state
            _this.draggingSeg = null; // TODO: rename to resizingSeg? matiereSeg?
            _this.eventRange = null;
            ...
            _this.handleHitUpdate = function (hit, isFinal, ev) {
                ...
                if (hit) {
                    mutation = computeMutation(initialHit, hit, ev.matiereEl.classList.contains('fc-start-resizer'), eventInstance.range, calendar.pluginSystem.hooks.eventResizeJoinTransforms);
                }
                if (mutation) {
        ...
        EventDragging.prototype.querySeg = function (ev) {
            return core.getElSeg(core.elementClosest(ev.matiereEl, this.component.fgSegSelector));
        };
        return EventDragging;
    }(core.Interaction));
    ...
    */
    var ExternalElementDragging = /** @class */ (function () {
        function ExternalElementDragging(dragging, suppliedDragMeta) {
            ...
            this.dragMeta = null;
            this.handleDragStart = function (ev) {
                _this.dragMeta = _this.buildDragMeta(ev.matiereEl);
            };
            this.handleHitUpdate = function (hit, isFinal, ev) {
                ...
                if (hit) {
                    ...
                    if (_this.canDropElOnCalendar(ev.matiereEl, receivingCalendar)) {
            ...
            this.handleDragEnd = function (pev) {
                ...
                if (receivingCalendar && droppableEvent) {
                    ...
                    var arg = __assign({}, receivingCalendar.buildDatePointApi(finalHit.dateSpan), { draggedEl: pev.matiereEl, jsEvent: pev.origEvent, view: finalView });
        ...
        ExternalElementDragging.prototype.buildDragMeta = function (matiereEl) {
            if (typeof this.suppliedDragMeta === 'object') {
                return core.parseDragMeta(this.suppliedDragMeta);
            }
            else if (typeof this.suppliedDragMeta === 'function') {
                return core.parseDragMeta(this.suppliedDragMeta(matiereEl));
            }
            else {
                return getDragMetaFromEl(matiereEl);
            }
        };
        ...
        function ExternalDraggable(el, settings) {
            ...
            this.handleDragStart = function (ev) {
                if (ev.isTouch &&
                    ...
                    ev.matiereEl.classList.contains('fc-event')) {
